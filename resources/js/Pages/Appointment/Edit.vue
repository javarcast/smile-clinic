<template>
    <DashboardLayout>
        <h2 class="text-2xl md:text-3xl text-slate-800 font-bold">Editar Cita</h2>
        <hr class="my-6" />
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="w-full">
                            ...
                            <select v-model="form.state_id" class="form-select block w-full rounded-md shadow-sm">
                    ...
                    <div class="flex md:flex-row justify-between sm:flex-col">
                        ...
                        <div>
                            ...
                            <input type="text" v-model="form.price" class="form-input mt-1 rounded-md shadow-sm" />
                        </div>
    ...
    data() {
        return {
            form: {
                ...
                state_id: this.appointment.state_id,
                price: "",
                observation: "",
